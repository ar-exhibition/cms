...
namespace cms.ar.xarchitecture.de.Controllers
{
    public class AssetTypesController : Controller
    {
        ...
        public AssetTypesController(cmsDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AssetTypeId,Designator")] AssetType assetType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AssetTypeId,Designator")] AssetType assetType)
        {
