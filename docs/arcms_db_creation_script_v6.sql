...
CREATE TABLE IF NOT EXISTS `cmsDatabase`.`Creator` (
  ...
  INDEX `fk_Creator_Studies_idx` (`Programme` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cmsDatabase`.`Course` (
  ...
  INDEX `fk_Course_Studies_idx` (`Programme` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cmsDatabase`.`SceneAsset` (
  ...
  `AssetType` INT NULL,
  PRIMARY KEY (`AssetID`),
  INDEX `fk_SceneAsset_Creator_idx` (`Creator` ASC) VISIBLE,
  INDEX `fk_SceneAsset_Course_idx` (`CourseName` ASC) VISIBLE,
  UNIQUE INDEX `AssetID_UNIQUE` (`AssetID` ASC) VISIBLE,
  INDEX `fk_SceneAsset_AssetType_idx` (`AssetType` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cmsDatabase`.`Anchor` (
  ...
  INDEX `fk_Anchor_SceneAsset_idx` (`AssetID` ASC) VISIBLE,
